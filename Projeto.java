...
public class Projeto implements InterPA {
    ...
    ArrayList<UsersI> users = new ArrayList<UsersI>();
    ArrayList<UsersI> users_projeto = new ArrayList<UsersI>();
    ArrayList<UsersI> users_intercambio = new ArrayList<UsersI>();
    ArrayList<UsersI> users_associados = new ArrayList<UsersI>();
    ...
    String coordenador, ArrayList<UsersI> users) {
