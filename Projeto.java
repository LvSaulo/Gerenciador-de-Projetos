...
public class Projeto implements InterPA {
    ...
    ArrayList<User> users_projeto = new ArrayList<User>();
    ArrayList<User> users_intercambio = new ArrayList<User>();
    ArrayList<User> users_associados = new ArrayList<User>();
    ...
    public Projeto(int identificacao, String descricao, String data_i, String data_t, String hora_i, String hora_t) {
    ...
    public Projeto(int identificacao, String descricao, String data_i, String data_t, String hora_i, String hora_t,
    String coordenador, ArrayList<User> users) {
        this.identificacao = identificacao;
        this.descricao = descricao;
        this.data_i = data_i;
        this.hora_i = hora_i;
    ...
    @Override
    public int getId() {return this.identificacao;}
    @Override
    ...
    public void editAtividades() {
        ...
        if(editA == 1) {
            ...
            int id_removeA = in.nextInt();
            for(int j = 0; j < atividades.size(); j++) {
                if(atividades.get(j).getId() == id_removeA) {
                    atividades.remove(j);
                    qntA--;
                }
            }
            ...
            int id_editA = in.nextInt();
            for(int j = 0; j < atividades.size(); j++) {
                if(atividades.get(j).getId() == id_editA) {
    ...
    public void consultarAtividade() {
        ...
        int id_atividade = in.nextInt();

        for(int i = 0; i < atividades.size(); i++) {
            if(atividades.get(i).getId() == id_atividade) {
