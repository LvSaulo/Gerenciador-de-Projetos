...
public class Atividade implements InterPA {
    ...
    ArrayList<User> users_atividade = new ArrayList<User>();
    ...
    public Atividade(int identificacao, String descricao, String data_i, String data_t, String hora_i, String hora_t, String responsavel, String profissional, String[] tarefas_per_profissional,
    ...
    public String getProfissional() {return this.profissional;}
    ...
    public String printAtividadeInfo() {
        return "Identificação: " + this.identificacao + "Descrição: " + this.descricao + "Data de inicio: "
                ...
                + "Hora de Término: " + this.hora_t + "Responsável: " + this.responsavel + "Profissionais: " + this.profissional + "\nTarefas: " + this.tarefas_per_profissional;
    }
